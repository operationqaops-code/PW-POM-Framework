...
- generic [ref=f3e1]:
  - generic [ref=f3e2]:
    ...
    - generic [ref=f3e10]:
      ...
      - link "Why did this happen?" [ref=f3e11] [cursor=pointer]:
        - /url: "#"
      - generic [ref=f3e12]: "IP address: 103.175.90.61Time: 2026-09-09T10:21:04ZURL: https://www.google.com/search?q=Test&sca_esv=ac456b0eb9994c0f&sxsrf=APpeQnuJcqmoVzkdeeUMX3vyilZv1265OA%3A1788949261162&source=hp&ei=DTOhapbVCLGVhvcPlM2NKA&iflsig=ABILxe8AAAAAaqFBHbEkje0fzWlqbPgBzVtQvfZao-kR&ved=0ahUKEwjWj-2po-GWAxWxiuEIHZRmAwUQ4dUDCB0&oq=Test&gs_lp=-ACAE&sclient=gws-wiz&sei=DzOhar_nFqbC4-EPtOibiA4"
  - iframe [active] [ref=f3e16]:
    - dialog [ref=f7e3]:
      ...
      - generic [ref=f7e49]:
        - generic [ref=f7e50]:
          - button "Get a new challenge" [ref=f7e52] [cursor=pointer]
          - button "Get an audio challenge" [ref=f7e54] [cursor=pointer]
          - button "Help" [ref=f7e56] [cursor=pointer]
        - button "Verify" [ref=f7e58] [cursor=pointer]
```

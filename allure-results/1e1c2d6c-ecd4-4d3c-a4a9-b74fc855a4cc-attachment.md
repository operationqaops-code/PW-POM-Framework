...
Call log:
  - waiting for locator('//h3[starts-with(text(),"Test")]').first()
    ...
    - navigated to "https://www.google.com/sorry/index?continue=https://www.google.com/search%3Fq%3DTest%26sca_esv%3Dac456b0eb9994c0f%26source%3Dhp%26ei%3DhDOhapabHYyphvcP-bKK-Qc%26iflsig%3DABILxe8AAAAAaqFBlG3EHw5GnFoDY…"
  ...
  - generic [ref=f3e2]:
    ...
    - generic [ref=f3e10]:
      ...
      - link "Why did this happen?" [ref=f3e11] [cursor=pointer]:
        - /url: "#"
      - generic [ref=f3e12]: "IP address: 103.175.90.61Time: 2026-09-09T10:23:03ZURL: https://www.google.com/search?q=Test&sca_esv=ac456b0eb9994c0f&source=hp&ei=hDOhapabHYyphvcP-bKK-Qc&iflsig=ABILxe8AAAAAaqFBlG3EHw5GnFoDYit1paxqAuRQKxmO&ved=0ahUKEwiW7eDio-GWAxWMlOEIHXmZIn8Q4dUDCB0&oq=Test&gs_lp=-ACAE&sclient=gws-wiz&sei=hjOhavmQM_b5seMP0NWh-QE"
  - iframe [active] [ref=f3e16]:
    - dialog [ref=f7e3]:
      - generic [ref=f7e4]:
        - generic [ref=f7e7]:
          - text: Select all images with
          - strong [ref=f7e8]: a fire hydrant
        ...
        - table [ref=f7e12]:
          - rowgroup [ref=f7e13]:
            ...
            - row [ref=f7e36]:
              ...
              - button [ref=f7e40]
              - button [ref=f7e44]
        - generic [ref=f7e47]: Please also check the new images.
      - generic [ref=f7e52]:
        - generic [ref=f7e53]:
          - button "Get a new challenge" [ref=f7e55] [cursor=pointer]
          - button "Get an audio challenge" [ref=f7e57] [cursor=pointer]
          - button "Help" [ref=f7e59] [cursor=pointer]
        - button "Verify" [active] [ref=f7e61] [cursor=pointer]
```

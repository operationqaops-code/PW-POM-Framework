  ...
  - generic [ref=f3e2]:
    ...
    - generic [ref=f3e10]:
      ...
      - link "Why did this happen?" [ref=f3e11] [cursor=pointer]:
        - /url: "#"
      - generic [ref=f3e12]: "IP address: 103.175.90.61Time: 2026-09-09T10:22:24ZURL: https://www.google.com/search?q=Test&sca_esv=ac456b0eb9994c0f&sxsrf=APpeQnuUDwi0NVE-TvzLZwpbFQVy5eWvug%3A1788949341087&source=hp&ei=XTOhap2BBKGfseMPtsL04Qs&iflsig=ABILxe8AAAAAaqFBbXxnoRpB15qYXyNyRkFc5iOvlxMr&ved=0ahUKEwjdo_vPo-GWAxWhT2wGHTYhPbwQ4dUDCB0&oq=Test&gs_lp=&sclient=gws-wiz&sei=XzOhaqqfEueJ4-EPgo-SoQw"
  - iframe [active] [ref=f3e16]:
    - dialog [ref=f7e3]:
      - generic [ref=f7e4]:
        - generic [ref=f7e9]:
          - text: Select all images with
          - strong [ref=f7e10]: cars
          - generic [ref=f7e11]: Click verify once there are none left
        - table [ref=f7e14]:
          - rowgroup [ref=f7e15]:
            - row [ref=f7e16]:
              - button [ref=f7e17]
            ...
            - row [ref=f7e26]:
              ...
              - button [ref=f7e34]
            - row [ref=f7e38]:
              - button [active] [ref=f7e39]
              - button [ref=f7e43]
              - button [ref=f7e46]
      - generic [ref=f7e53]:
        - generic [ref=f7e54]:
          - button "Get a new challenge" [ref=f7e56] [cursor=pointer]
          - button "Get an audio challenge" [ref=f7e58] [cursor=pointer]
          - button "Help" [ref=f7e60] [cursor=pointer]
        - button "Verify" [ref=f7e62] [cursor=pointer]
```

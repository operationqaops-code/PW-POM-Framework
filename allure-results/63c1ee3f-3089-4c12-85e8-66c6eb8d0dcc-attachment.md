...
- Location: tests\practice.spec.ts:138:1
...
Expected: "Copy Text"
Received: {"_apiName": "Locator", "_frame": {"_guid": "frame@7d4f19190176873d6c143e855e70cf78", "_type": "Frame"}, "_selector": "#field2", Symbol(nodejs.util.inspect.custom): [Function anonymous]}
```
            ...
            - table [ref=e204]:
              ...
              - rowgroup [ref=e212]:
                - row [ref=e213]:
                  ...
                  - cell "88.7 MB" [ref=e215]
                  - cell "0.47 MB/s" [ref=e216]
                  - cell "0.2 Mbps" [ref=e217]
                  - cell "9.9%" [ref=e218]
                - row [ref=e219]:
                  - cell "Internet Explorer" [ref=e220]
                  - cell "36.7 MB" [ref=e221]
                  - cell "0.37 MB/s" [ref=e222]
                  - cell "8.3 Mbps" [ref=e223]
                  - cell "2.4%" [ref=e224]
                - row [ref=e225]:
                  - cell "Chrome" [ref=e226]
                  - cell "82.0 MB" [ref=e227]
                  - cell "0.09 MB/s" [ref=e228]
                  - cell "0.5 Mbps" [ref=e229]
                  - cell "5.9%" [ref=e230]
                - row [ref=e231]:
                  - cell "System" [ref=e232]
                  - cell "76.5 MB" [ref=e233]
                  - cell "0.66 MB/s" [ref=e234]
                  - cell "0.1 Mbps" [ref=e235]
                  - cell "3.8%" [ref=e236]
            - generic [ref=e237]:
              - paragraph [ref=e238]:
              ...
              - paragraph [ref=e240]:
                ...
                - strong [ref=e241]: 88.7 MB
              - paragraph [ref=e242]:
                - text: "Network speed of Chrome process:"
                - strong [ref=e243]: 0.5 Mbps
              - paragraph [ref=e244]:
                - text: "Disk space of Firefox process:"
                - strong [ref=e245]: 0.47 MB/s
        - generic [ref=e246]:
...
```ts
  ...
  105 | 
  106 | test.skip("Switch window Handling", async ({ page }) => {
  107 | 
  ...
  113 |         await page.getByRole('button', { name: 'New Tab' }).click()
  114 |     ]);
  115 | 
  116 |     await newTab.waitForLoadState();
  117 |     await newTab.getByRole('link', { name: 'Online Training' }).click();
  118 |     await page.pause();
  119 | 
  120 | });
  121 | 
  122 | //*********Handling Mouse Actions(Mouse Hover)**********
  123 | 
  124 | test.skip("Handling Mouse Hover Over the Page",async({page})=>{
  125 |     
  126 |     await page.goto("https://testautomationpractice.blogspot.com/");
  127 |     const MouseLocator:Locator=page.getByRole('button',{name:'Point Me'});
  128 |     await MouseLocator.hover();
  129 |     await page.getByRole('link',{name:'Mobiles'}).click();
  ...
  134 | });
  135 | 
  136 | //**********Handling Mouse Double click and verify the text copied from Filed1 and paste to Field2**********
  137 | 
  138 | test("Handling Mouse Double Click Actions",async({page})=>{
  139 |     await page.goto("https://testautomationpractice.blogspot.com/");
  140 | 
  141 |     await page.getByRole('button',{name:'Copy Text'}).dblclick();
  142 |     const text1=await page.getByRole('button',{name:'Copy Text'}).textContent();
  143 |     const text2=page.locator("#field2");
> 144 |     expect(text2).toBe(text1);
      |                   ^ Error: expect(received).toBe(expected) // Object.is equality
  145 |  
  146 | });
  147 | 

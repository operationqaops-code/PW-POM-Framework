...
- generic [ref=f3e1]:
  - generic [ref=f3e2]:
    ...
    - generic [ref=f3e10]:
      ...
      - link "Why did this happen?" [ref=f3e11] [cursor=pointer]:
        - /url: "#"
      - generic [ref=f3e12]: "IP address: 103.175.90.61Time: 2026-09-09T10:20:23ZURL: https://www.google.com/search?q=Test&sca_esv=ac456b0eb9994c0f&source=hp&ei=5DKhavyWKuGfhvcP0smjqA8&iflsig=ABILxe8AAAAAaqFA9O1uiazDvqTT7eaFrxf1Q8o150Fn&ved=0ahUKEwj8mMiWo-GWAxXhj-EIHdLkCPUQ4dUDCB0&oq=Test&gs_lp=&sclient=gws-wiz&sei=5jKhaoTxNvKB2roPmtqtyAU"
  - iframe [active] [ref=f3e16]:
    - dialog [ref=f7e3]:
      ...
      - generic [ref=f7e51]:
        - generic [ref=f7e52]:
          - button "Get a new challenge" [ref=f7e54] [cursor=pointer]
          - button "Get an audio challenge" [ref=f7e56] [cursor=pointer]
          - button "Help" [ref=f7e58] [cursor=pointer]
        - button "Verify" [ref=f7e60] [cursor=pointer]
```
